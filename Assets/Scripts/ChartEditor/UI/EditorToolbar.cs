...
namespace SCOdyssey.ChartEditor.UI
{
    ...
    public class EditorToolbar : MonoBehaviour
    {
        ...
        [Header("자동생성")]
        public Button btnAutoGenerate;
        public GameObject autoGenerateDropdownPanel;
        public Button btnGenEasy;
        public Button btnGenNormal;
        public Button btnGenHard;
        public Button btnGenExtreme;
        ...
        private void SetupButtonListeners()
        {
            ...
            // 자동생성
            if (btnAutoGenerate != null)
                btnAutoGenerate.onClick.AddListener(() => TogglePanel(autoGenerateDropdownPanel));
            if (btnGenEasy != null)
                btnGenEasy.onClick.AddListener(() => OnAutoGenerate(Difficulty.Easy));
            if (btnGenNormal != null)
                btnGenNormal.onClick.AddListener(() => OnAutoGenerate(Difficulty.Normal));
            if (btnGenHard != null)
                btnGenHard.onClick.AddListener(() => OnAutoGenerate(Difficulty.Hard));
            if (btnGenExtreme != null)
                btnGenExtreme.onClick.AddListener(() => OnAutoGenerate(Difficulty.Extreme));
        }
        ...
        private void CloseAllPanels()
        {
            ...
            if (autoGenerateDropdownPanel != null) autoGenerateDropdownPanel.SetActive(false);
        }

        private void OnAutoGenerate(Difficulty difficulty)
        {
            CloseAllPanels();
            editorManager.GenerateChart(difficulty);
        }
